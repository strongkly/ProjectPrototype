	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag (v2f i) : COLOR
			{
				...
				texcol.a *= step(alphaCoords.x, 1.0 - _ClampBorder);
				texcol.a *= step(_ClampBorder, alphaCoords.x);
				texcol.a *= step(alphaCoords.y, 1.0 - _ClampBorder);
				texcol.a *= step(_ClampBorder, alphaCoords.y);
